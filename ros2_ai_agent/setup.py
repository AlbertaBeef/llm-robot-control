...
setup(
    ...
    description='ROS 2 AI agent package',
    license='Apache License 2.0',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'ros2_ai_agent_turtlesim = ros2_ai_agent.ros2_ai_agent_turtlesim:main',
            'ros2_ai_agent_robotic_arm = ros2_ai_agent.ros2_ai_agent_robotic_arm:main',            
        ],
    },
)
